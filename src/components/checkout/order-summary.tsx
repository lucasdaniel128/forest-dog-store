...
export function OrderSummary({ paymentMethod = "pix" }: OrderSummaryProps) {
  return (
    <div className="rounded-2xl border border-border bg-surface-strong p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] sm:p-6">
      ...
      <div className="mt-5 flex gap-4">
        <img
          src={productImage}
          alt={PRODUCT.name}
          className="h-[80px] w-[80px] shrink-0 rounded-xl object-cover shadow-sm"
        />
