...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-xl text-[15px] font-bold uppercase tracking-wide transition-all duration-200 [transition-property:color,background-color,border-color,box-shadow,opacity] active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
